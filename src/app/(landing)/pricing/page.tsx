    ...
    <div className="bg-gray-950 py-24 sm:py-32">
      <MaxWidthWrapper>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-base/7 text-gray-300 max-w-prose text-center text-pretty">
            We hate subscriptions. And chances are, you do too. That's why we
            offer lifetime access to EventLabs for a one-time payment.
          </p>
        </div>

        <div className="bg-gray-900/40 mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-800 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            <h3 className="text-3xl font-heading font-semibold tracking-tight text-white">
              Lifetime access
            </h3>

            <p className="mt-6 text-base/7 text-gray-300">
              Invest once in EventLabs and transform how you monitor your SaaS
            ...
            <ul className="mt-8 grid grid-cols-1 gap-4 text-sm/6 text-gray-300 sm:grid-cols-2 sm:gap-6">
          ...
          <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-gray-900/80 py-10 text-center ring-1 ring-inset ring-gray-800 lg:flex lg:flex-col lg:justify-center lg:py-16">
