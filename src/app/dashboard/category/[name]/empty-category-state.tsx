...
export const EmptyCategoryState = ({
  ...
  return (
    ...
    >
      <h2 className="text-xl/8 font-medium text-center tracking-tight text-white">
        Create your first {categoryName} event
      </h2>
      <p className="text-sm/6 text-gray-300 mb-8 max-w-md text-center text-pretty">
        Get started by sending a request to our tracking API:
      </p>

      <div className="w-full max-w-3xl bg-gray-900 rounded-lg shadow-lg overflow-hidden border border-gray-800">
      ...
      <div className="mt-8 flex flex-col items-center space-x-2">
        ...
        <p className="text-sm/6 text-gray-300 mt-2">
